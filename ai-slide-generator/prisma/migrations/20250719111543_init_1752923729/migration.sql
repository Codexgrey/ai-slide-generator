/*
  ...
  - You are about to drop the column `description` on the `Presentation` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE "Presentation" DROP COLUMN "description",
